...
from trainers.dgtrainer_LGLC import DGTrainer

# from models.models import DGModel_base, DGModel_mem, DGModel_memadd, DGModel_cls, DGModel_memcls, DGModel_final
"""from models.mdknet import DGModel_base, DGModel_mem, DGModel_memcls, DGModel_final"""
from models.Re_FSDAmodel import DGModel_base, DGModel_mem, DGModel_memcls, DGModel_final
...
def load_config(config_path, task):
    ...
    if task == "train" or task == "train_test":
        ...
        task_params["save_dir"] = cfg["save_dir"]
    if task != "train":
